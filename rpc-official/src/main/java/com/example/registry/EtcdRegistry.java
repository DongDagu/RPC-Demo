...
//        kvClient.delete(ByteSequence.from(registerKey, StandardCharsets.UTF_8));
        ByteSequence sequence = ByteSequence.from(registerKey, StandardCharsets.UTF_8);
        ByteSequence from = ByteSequence.from(registerKey.getBytes());
        // TODO 注销服务失败，未能删除指定服务
        kvClient.delete(from);
        // 移除本地缓存
    ...
    /**
     * 使用JVM提供的shutdownHook功能实现服务关机后自动注销调用此方法
     */
    @Override
    public void destroy() {
